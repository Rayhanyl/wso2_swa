...
<head>
    <title>REPORT MONTHLY API USAGE API SWAMEDIA</title>
</head>
<style type="text/css">
    body {
...
<body>
    <div class="head-title">
        <h4 class="m-0 p-0">REPORT MONTHLY API USAGE API SWAMEDIA</h4>
    </div>
    <div class="table-section mt-20">
        <table class="table w-100 mt-10">
            ...
            <tr>
                ...
                <td class="w-50 text-capitalize">{{ $customer }}</td>
            </tr>
            <tr>
    ...
    <div class="my-20">
        <p class="second-text">Total Customer :<span>&nbsp; {{ $customercount }}</span></p>
