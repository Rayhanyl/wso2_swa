...
<head>
    <title>REPORT ERROR SUMMARY SWAMEDIA</title>
</head>
<style type="text/css">
    body {
...
<body>
    <div class="head-title">
        <h4 class="m-0 p-0">REPORT ERROR SUMMARY SWAMEDIA</h4>
    </div>
    <div class="table-section mt-20">
        <table class="table w-100 mt-10">
            <tr>
                <th class="first-text w-50">Date Now</th>
                <td class="w-50">{{ $datenow }}</td>
            </tr>
            <tr>
                <th class="first-text w-50">API Name</th>
                <td class="w-50">{{ $api_name }}</td>
            </tr>
            <tr>
                <th class="first-text w-50">Type</th>
                <td class="w-50">{{ $view_type }}</td>
            </tr>
        </table>
    </div>
    <div class="table-section bill-tbl w-100 my-20">
        <table class="table w-100 mt-10">
            <thead>
                <tr>
