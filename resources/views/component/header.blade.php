                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="dropdown">
                                <a href="#" class="nav-link nav-font mx-2 reset-local-storage dropdown-toggle" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                    Summary
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <li><a class="dropdown-item" href="{{ route ('customer.monthly.report.summary.page') }}">Report</a></li>
                                    <li><a class="dropdown-item" href="{{ route ('customer.api.resource.usage.summary.page') }}">Usage</a></li>
