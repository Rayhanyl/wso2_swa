...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <a class="back-to-application" href="{{ route ('application.page') }}"><i class='bx bxs-chevron-left' ></i> Back To Application</a>
            </div>
                ...
                <div class="col-12 col-lg-3">
                    <div class="card card-shadow-app rounded-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4 d-flex align-items-center justify-content-center">
                                    <img width="50" height="50" src="{{ asset ('assets/images/application/icon-hold.png') }}" alt="">
                                </div>
                                <div class="col-8 text-center">
                                    <div class="fw-bold" style="font-size: 18px;">
                                       On Hold
            ...
            <div class="col-12 my-5">
                ...
                <div class="">
                    <h4 class="fw-bold text-warning">No subscriptions are available for this Application <i class="bi bi-exclamation-diamond"></i></h4>
                    <a type="button" class="btn-add-subs" id="btn-add-subs" data-app-id="{{ $application->applicationId }}">Click here to start subscribing API <i class='bx bxs-hand-up'></i></a>
                </div>
                @else
                <div class="my-4">
                    <button class="btn btn-primary rounded-3" id="btn-add-subs" data-app-id="{{ $application->applicationId }}" >Add Subscription <span class="icon-position"> <img width="13" height="9" src="{{ asset ('assets/images/icon/plus-icon.png') }}"  alt=""> </span></button>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($items->status == 'ON_HOLD')
                                                <p class="text-warning fw-semibold" data-toggle="tooltip" data-placement="left" title="Waiting for approval from admin"> 
                                                    {{$items->status}} <span class="subs-status-icon"> <img width="17" height="17" src="{{ asset ('assets/images/application/hold.png') }}" alt="Hold">  </span>
                                                </p>
                                            @elseif($items->status == 'REJECTED')
                                                <p class="text-danger fw-semibold" data-toggle="tooltip" data-placement="left" title="Rejected"> 
                                                    {{$items->status}} <span class="subs-status-icon"> <img width="17" height="17" src="{{ asset ('assets/images/application/reject.png') }}" alt="Rejected"> </span>
                                                </p>
                                            @else
                                                <p class="text-primary fw-semibold" data-toggle="tooltip" data-placement="left" title="Approved"> 
                                                    {{$items->status}} <span class="subs-status-icon"> <img width="17" height="17" src="{{ asset ('assets/images/application/approve.png') }}" alt="Approved">  </span>
                                                </p>
                                            @endif
                                        </td>
                                        <td>
                                            @if ($items->status == 'REJECTED')
                                            <button type="button" class="btn btn-warning btn-edit-subs rounded-4" data-subs-id="{{ $items->subscriptionId }}" disabled>
                                            ...
                                            <button type="button" class="btn btn-warning btn-edit-subs rounded-4" data-subs-id="{{ $items->subscriptionId }}">
                                                <i class='bx bx-edit-alt' style="color: white;"></i>
                                            </button>
                                            <a class="btn btn-danger btn-deletesubs rounded-4"
                                                href="{{ route ('delete.subscription',$items->subscriptionId) }}">
                                            ...
                                            href="{{ route ('tryout.page',$application->applicationId) }}" id="btn-tryout" data-api-id="{{ $items->apiId }}">
                                            Tryout
