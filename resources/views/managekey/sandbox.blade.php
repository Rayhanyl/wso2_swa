        ...
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <nav class="nav">
                    <div class="row">
                        <div class="col-6">
                            <a class="nav-managekey active" aria-current="page" href="{{ route ('sandbox.page',$application->applicationId) }}">Sandbox</a>
                        </div>
                        <div class="col-6">
                            <a class="nav-managekey" href="{{ route ('production.page',$application->applicationId) }}">Production</a>
                        </div>
                    </div>
                </nav>
                <hr>
            ...
            <div class="sandbox-oauth-page" id="sandbox-oauth-page">
                <div class="col-12 my-3">
                    <form class="row g-4"
            ...
            <div class="sandbox-apikey-page row" id="sandbox-apikey-page" style="display: none;">
