                    ...
                    <div class="col-12 my-2">
                     ...
                     <div class="col-12 my-2">
                        <form class="row" action="{{ route ('resetpassword') }}" method="POST">
                            ...
                            <div class="col-12 mb-4 @error('password') is-invalid @enderror">
                            ...
                            <div class="col-12 mb-4 @error('password_confirmation') is-invalid @enderror">
                                <label for="password_confirmation" class="form-label">Konfrimasi Password</label>
                                <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" placeholder="Masukan kembali password anda">
