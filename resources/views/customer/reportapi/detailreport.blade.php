    ...
    <div class="row">
        ...
        <div class="col-12 mb-5">
            <div class="card card-shadow-app rounded-4">
                <div class="card-header">
                    <div class="row"> 
                        ...
                        <div class="col-12 col-lg-6 text-end my-auto">
                            <a href="{{ route ('customer.detail.logs.report.pdf')}}?api={{ $api_id }}&app={{ $app_id }}&year={{ $year }}&month={{ $month }}" class="btn btn-primary mx-2 ">
                ...
                <div class="card-body">
                    <table class="table table-striped" id="data-table-log-detail-customer" style="width:100%">
...
<script>
    $(document).ready(function () {
        $('#data-table-log-detail-customer').DataTable({
            responsive: true,
            lengthMenu: [
                [5, 25, 50, -1],
                [10, 25, 50, 'All'],
