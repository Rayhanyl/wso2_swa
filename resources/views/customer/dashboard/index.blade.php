                            ...
                            <table class="table table-striped" id="data-table-dashboard-quota-subscription"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="progress" dir="rtl">
                                                <div class="progress-bar" role="progressbar" aria-label="Example with label" style="width: 50%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">50</div>
                                              </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="progress" dir="rtl">
                                                <div class="progress-bar" role="progressbar" aria-label="Example with label" style="width: 70%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">70</div>
                                              </div>
...
@push('script')
    <script>
        ...
        var data = {
            labels: ['Calculator', 'Pizzahack', 'Jsonplaceholder'],
            datasets: [{
                label: 'Usage',
                data: [200, 150, 550],
                backgroundColor: [
